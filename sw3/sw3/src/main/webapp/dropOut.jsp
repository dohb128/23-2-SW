		...
		<div class="signform">
			<div class="signform-main">
				...
				<div class="signform-input">
					<form method="post" action="dropOutProcess.jsp" name="dropInfo" onsubmit="return check()">
						<p>계정 : <%=userID %></p>
						...
						<div class="input_chk">
							...
							<label for="termsEmail" id="termsEmailLb">회원 탈퇴 시 다시 복구하지 못합니다. 이에 동의하십니까?</label>
						</div>
